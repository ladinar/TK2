$(document).ready(function(){
	...
	var apiKey = '07a414c01835fd0e21580fe28c87a19f'
			...
			for(let i = 0; i<nowPlayingData.results.length; i++){
				...
				$.getJSON(thisMovieUrl, function(movieKey){
					...
					nowPlayingHTML += '<div class="col-sm-3 eachMovie">';
						nowPlayingHTML += '<button type="button" class="btnModal" data-toggle="modal" data-target="#exampleModal'+ i + '" data-whatever="@' + i + '">'+'<img src="'+poster+'" style="object-fit: cover;max-width: 500px;border: 2px white solid;max-height:350px"></button>'; 	
			...
			for(let i = 0; i<genreData.results.length; i++){
				...
				$.getJSON(thisMovieUrl, function(movieKey){
					...
					genreHTML += '<div class="col-sm-3 col-md-3 col-lg-3 eachMovie">';
						genreHTML += '<button type="button" class="btnModal" data-toggle="modal" data-target="#exampleModal'+ i + '" data-whatever="@' + i + '">'+'<img src="'+poster+'" style="object-fit: cover;max-width: 500px;border: 2px white solid;max-height:350px"></button>'; 	
		...
		$.getJSON(nowPlayingURL, function(sortData){
			...
			for(let i = 0; i<sortData.results.length; i++){
				...
				$.getJSON(thisMovieUrl, function(movieKey){
					...
					var youtubeLink = 'https://www.youtube.com/watch?v='+youtubeKey;
					var sortHTML = '';
					sortHTML += '<div class="col-sm-3 col-md-3 col-lg-3 eachMovie">';
						sortHTML += '<button type="button" class="btnModal" data-toggle="modal" data-target="#exampleModal'+ i + '" data-whatever="@' + i + '">'+'<img src="'+poster+'" style="object-fit: cover;max-width: 500px;border: 2px white solid;max-height:350px"></button>'; 	
			...
			for (let i = 0; i<movieSearchResults.results.length; i++){
				...
				$.getJSON(thisMovieUrl, function(movieKey){
					...
					searchResultsHTML += '<div class="col-sm-3 col-md-3 col-lg-3 eachMovie">';
						searchResultsHTML += '<button type="button" class="btnModal" data-toggle="modal" data-target="#exampleModal'+ i + '" data-whatever="@' + i + '">'+'<img src="'+poster+'" style="object-fit: cover;max-width: 500px;border: 2px white solid;max-height:350px"></button>'; 	
